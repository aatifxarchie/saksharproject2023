...
a1scene = pygame.image.load("a1scene.png")
apples1_image = pygame.image.load("apples1.png")
axe1_image = pygame.image.load("axe1.png")
...
a1scene_status = 0
apples1_image_status = 0 #inactive
axe1_image_status = 0 #inactive
...
while control: #main running loop of the game screen
    ...
    if post_stars_scene_status == 1:
        ...
        my_button_23 = Button("NEXT",455,570,True,50,90)
        my_button_23.draw()
    ...
    if a1scene_status == 1:
        screen.blit(a1scene,(0,0))
        input_27 = my_button_25.check_click()
        if input_27 :
            apples1_image_status = 1
        input_28 = my_button_26.check_click()
        if input_28:
            axe1_image_status = 1
        
    if apples1_image_status == 1:
        screen.blit(apples1_image,(0,0))

    if axe1_image_status == 1:
        screen.blit(axe1_image,(0,400))
